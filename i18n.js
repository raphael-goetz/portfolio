(function () {
    ...
    const translations = {
        ...
        "My work on CodeZero combines product direction, technical architecture, backend engineering, and coordination of engineering tasks across the team.": "Meine Arbeit an CodeZero verbindet Produktentwicklung, technische Architektur, Backend-Engineering und die Koordination der Entwicklungsaufgaben im Team.",
        ...
        "Software architect, technical lead, backend engineer": "Softwarearchitekt, technischer Leiter, Backend-Entwickler",
        ...
        "Compared to CodeZero, where I planned selected services, o7 required end-to-end technical direction across the engineering track. I planned the architecture, broke down implementation tasks, coordinated the work of my developer partners, and kept the backend, proxy, and Minecraft tooling pieces aligned as one system.": "Im Gegensatz zu CodeZero, wo ich ausgewählte Services plante, erforderte o7 eine durchgängige technische Ausrichtung der Entwicklung. Ich entwarf die Architektur, zerlegte sie in Implementierungsaufgaben, koordinierte meine Entwicklungspartner und hielt Backend, Proxy und Minecraft-Werkzeuge als Gesamtsystem aufeinander abgestimmt.",
